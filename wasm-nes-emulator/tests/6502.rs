...
mod cmp {
    ...
    fn cmp_gt_p() {
        ...
        cpu.load_and_run(vec![
            0xa9, 0x05, 0xc9, 0x03, 0xf0, 0x04, 0xb0, 0x02, 0xa9, 0x00, 0x00,
        ]);
    ...
    fn cmp_gt_f() {
        let mut cpu = CPU::new();
        cpu.load_and_run(vec![
            0xa9, 0x05, 0xc9, 0x09, 0xf0, 0x04, 0xb0, 0x02, 0xa9, 0x00, 0x00,
        ]);
...
mod cpx {
    ...
    fn cpx_gt_p() {
        let mut cpu = CPU::new();
        cpu.load_and_run(vec![
            0xa2, 0x05, 0xe0, 0x03, 0xf0, 0x04, 0xb0, 0x02, 0xa2, 0x00, 0x00,
        ]);
    ...
    fn cpx_gt_f() {
        let mut cpu = CPU::new();
        cpu.load_and_run(vec![
            0xa2, 0x05, 0xe0, 0x09, 0xf0, 0x04, 0xb0, 0x02, 0xa2, 0x00, 0x00,
        ]);
...
mod cpy {
    ...
    fn cpy_gt_p() {
        let mut cpu = CPU::new();
        cpu.load_and_run(vec![
            0xa0, 0x05, 0xc0, 0x03, 0xf0, 0x04, 0xb0, 0x02, 0xa0, 0x00, 0x00,
        ]);
    ...
    fn cpy_gt_f() {
        let mut cpu = CPU::new();
        cpu.load_and_run(vec![
            0xa0, 0x05, 0xc0, 0x09, 0xf0, 0x04, 0xb0, 0x02, 0xa0, 0x00, 0x00,
        ]);
...
mod jmp {
    ...
    fn jmp_skip_some() {
        ...
        cpu.load_and_run(vec![
            0x4c, 0x05, 0x06, 0xa9, 0x01, 0xa9, 0x02, 0x4c, 0x0c, 0x06, 0xa9, 0x00, 0x00,
        ]);
...
mod jsr {
    ...
    fn jsr() {
        ...
        cpu.load(vec![0x20, 0x03, 0x06, 0x00]);
        cpu.reset();
        cpu.next(); //jsr
...
mod rts {
    ...
    fn rts() {
        ...
        cpu.load(vec![0x20, 0x05, 0x06, 0xa2, 0x05, 0xa9, 0x05, 0x60, 0x00]);
        cpu.reset();
        cpu.next(); //JSR
        cpu.next(); //LDA
        cpu.next(); //RTS
